...
namespace ACEngine.Engine.Scene
{
    internal class Scene
    {
        ...
        public void Start()
        {
            ...
            main_camera.AddComponent(new CameraMove());
            ...
            Behavior.Spawn(GameObject.Create(new Mesh(Model.Cube)), new Vector3(0, 0, 5), new Vector3(0, 0, 90)).AddComponent(new RotateMove());
            OnStart();
        }
    }
}
